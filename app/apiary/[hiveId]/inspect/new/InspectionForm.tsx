...
import InspectionPhotoUpload from '@/app/apiary/InspectionPhotoUpload'
...
export default function InspectionForm({ hiveId, userId, isPro }: { hiveId: string; userId: string; isPro: boolean }) {
      ...
      <div className="container mx-auto px-5 lg:px-8" style={{ paddingTop: '2.5rem', paddingBottom: '4rem' }}>
        <div className="card" style={{ maxWidth: 640, padding: '2rem' }}>
          <form action={formAction} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* PRO: Photos */}
            <InspectionPhotoUpload userId={userId} hiveId={hiveId} isPro={isPro} />
